...
var lineImg = document.createElement('img');
  lineImg.src = "/assets/img//ml1/pink-dot.png";

  var dataImg = document.createElement('img');
  dataImg.src = "/assets/img//ml1/blue-dot.png";

var background = document.createElement('img');
background.src = "/assets/img//ml1/coordinates.svg";
...
//    }
    ...
    for (var i = 0; i < l; i++) {
      var shape = shapes[i];
      pred = m * (shape.x - ax) + ay;   // Line's prediction
      e = pred - shape.y                // Error in prediction
      // Add normalized squared error
      sum += (e * e) / 1000;
    }
    ...
    document.getElementById("cost").innerHTML = "Costo: " + outputSum;
